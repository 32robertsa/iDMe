...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('root://cmseos.fnal.gov//store/group/lpcmetx/iDMe/gridpacks/run3_renamed/#gridpack#_el9_amd64_gcc11_CMSSW_13_0_13_tarball.tar.xz'),
...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
            ...
            processParameters = cms.vstring(
                #'SLHA:keepSM = on', # deprecated in Pythia 8
                'SLHA:minMassSM = 10.',
                ...
                '1000023:mWidth = 0.1973269804e-#exp#', # 100mm must set decay length by width; doing it by tau0 has not worked in the past #1.9732e-15
                # 1mm: exp = 12; 10mm: exp = 13; 100mm: exp = 14; 1000mm: exp = 15
