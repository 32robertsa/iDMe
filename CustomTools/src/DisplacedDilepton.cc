...
DisplacedDileptons::DisplacedDileptons(reco::Vertex &pv_, reco::BeamSpot &beamspot_, edm::Handle<std::vector<pat::IsolatedTrack> > &isotracks_, edm::Handle<std::vector<pat::Photon> > &photons_, edm::Handle<std::vector<pat::PackedCandidate> > &packedPFCandidates_, const TransientTrackBuilder& theTransientTrackBuilder_) : theTransientTrackBuilder(theTransientTrackBuilder_) {
